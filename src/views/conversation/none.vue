      ...
      <div class="tyn-chat-none-bg">
        <svg width="360" viewBox="0 0 303 172" fill="none" class="">
            ...
            <rect x=".445" y=".55" width="50.58" height="100.068" rx="7.5"
                transform="rotate(6 -391.775 121.507) skewX(.036)" fill="#3274eec7" stroke="#3274eec7">
            </rect>
            ...
            <path
                ...
                fill="var(--intro-svg4)" stroke="#3274eec7">
            </path>
            <path
            ...
            <circle transform="rotate(-3.989 1304.861 -2982.552) skewX(.021)" fill="#3274eec7"
